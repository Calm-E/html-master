customElements.define('pop-header', class extends HTMLElement{
    ...
    <a class="pop-home-icon header-icon" href="./../">
    <svg
      aria-label="Home"
      title="Home"
      width="60px"
    ...
    <div class="pop-header-alert">
    Join us in person at Saturday at 9:00AM or via
    <a href="https://www.youtube.com/@PrinceofPeaceGhanaSDAChurch/streams">Livestream at 9:30AM</a>
</div>
...
customElements.define('pop-footer', class extends HTMLElement{
     constructor(){
          ...
          this.innerHTML =`
    <footer>
      <div class="pop-max-container pop-footer-section grid-to-block">
      <div>
      <a href="index.html">
      ...
      <div>
        <p style="margin-top: 0">
         990 Kingsmil Pkwy<br />
          Columbus, OH 43229
        </p>

        <a href="tel:+1-614-800-4147">614-800-4147 </a><br />
      ...
      <div>
        ...
        <a href="#">Youth</a><br />
        <a href="https://adventistgiving.org/#/org/ANBF23/envelope/start">Giving</a><br />
      </div>

      <div>
        <a href="https://www.youtube.com/@PrinceofPeaceGhanaSDAChurch/streams">Livestreams</a><br />
      </div>
      ...
      <div>
        ...
        <a href="https://www.instagram.com/popgsdach/?hl=en" target="_blank" style="font-size: 1.5em" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a><br />
        <a href="https://www.youtube.com/@PrinceofPeaceGhanaSDAChurch/streams" target="_blank" style="font-size: 1.5em" aria-label="YouTube"><i class="fa-brands fa-youtube"></i></a><br />
      </div>
